...
@TargetApi(14)
public class TitleBarLeft extends RelativeLayout implements OnClickListener, ITitle {
	...
	public TitleBarLeft(Context context, AttributeSet attrs) {
		this(context, attrs, null);
	}

	public TitleBarLeft(Context context, AttributeSet attrs, Fragment fragment) {
		this(context, attrs, R.attr.titleBarStyle, fragment);
	}

	public TitleBarLeft(Context context, AttributeSet attrs, int defStyle,
			Fragment fragment) {
		...
		inflater.inflate(R.layout.widget_titlebar_left, this);
		initElements();
		initHomeAndBack();
		initMenuItems();
	}
	...
	private void initHomeAndBack() {
		...
		homeItem.mItemId = mBack.getId();
		mMenuItemMap.put(mBack, homeItem);
	}
