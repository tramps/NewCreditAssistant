...
//		Log.i(TAG, "mScaledDensity" + mScaledDensity);
//		Log.i(TAG, "mIndexbarWidth" + mIndexbarWidth);
//		Log.i(TAG, "mIndexbarMargin" + mIndexbarMargin);
//		Log.i(TAG, "mPreviewPadding" + mPreviewPadding);
	}
