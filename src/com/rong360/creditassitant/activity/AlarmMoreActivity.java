...
public class AlarmMoreActivity extends BaseActionBar implements OnClickListener {
	...
	finish();
	Intent inte = new Intent(this, AlarmMoreActivity.class);
	startActivity(inte);
	...
	MPlayHelper.silentAlarm(AlarmMoreActivity.this);
	super.onDestroy();
    }
...
//	    clearDisplay();
	...
	for (Customer c : mAlarmCustomers) {
	    ...
	    GlobalValue.getIns().getActionHandler(AlarmMoreActivity.this)
		    .handleAction(action);
	}
