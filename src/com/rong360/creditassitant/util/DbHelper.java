...
//		mInfos.add(NoticeIgnoreHandler.TABLE_INFO);
	...
	public static class TableInfo {
		...
		public boolean equals(Object o) {
			if (o instanceof TableInfo) {
				return tableName != null && tableName.equals(((TableInfo)o).tableName);
			}
	...
	public abstract static class BaseDbHandler {
		...
		public void deleteAll() {
			SQLiteStatement statement = mHelper.getWritableDatabase().compileStatement("delete from " + getTablename());
			statement.execute();
		}
		
		public int getCount() {
			SQLiteStatement statement = mHelper.getReadableDatabase().compileStatement("select count(*) from " + getTablename());
